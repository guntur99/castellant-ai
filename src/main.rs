...
async fn main() {
    ...
    let app = Router::new()
        ...
        .route("/admin/marketing", get(handlers::admin_marketing))
        .route("/api/invitation", post(handlers::create_invitation))
        .route("/api/validate-promo", get(handlers::validate_promo))
        ...
        .route("/invitation/{slug}/guests/bulk", post(handlers::bulk_add_guests))
        ...
        .route("/invitation/{slug}/guests/{guest_id}/toggle-sent", post(handlers::toggle_guest_sent))
